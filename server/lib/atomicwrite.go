// Package lib provides shared server-side utilities for field-station.
package lib
...
// The file is written with permissions 0o600 regardless of the existing file's permissions.
